...
a = getDivision(y0, a);
        ...
        c = getDivision(y2, c);
        d = getDivision(y3, d);
       // double a = ((x0 - x1) * (x0 - x2) * (x0 - x3));
        // double b = ((x1 - x0) * (x1 - x2) * (x1 - x3));
        // double c = ((x2 - x0) * (x2 - x1) * (x2 - x3));
        //double d = ((x3 - x0) * (x3 - x1) * (x3 - x2));
       ...
       c1 = a.add(b).add(c).add(d);
        ...
        BigDecimal c4 = a.multiply(x1).multiply(x2).multiply(x3)
                ...
                .add(d.multiply(x0).multiply(x1).multiply(x2));
        ...
        /*double c1 = a + b + c + d;
        double c2 = -(a * (x1 + x2 + x3)
                + b * (x0 + x2 + x3)
                + c * (x0 + x1 + x3)
                + d * (x0 + x1 + x2));
        double c3 = a * (x1 * x2 + x1 * x3 + x2 * x3)
                + b * (x0 * x2 + x0 * x3 + x2 * x3)
                + c * (x0 * x1 + x0 * x3 + x1 * x3)
                + d * (x0 * x1 + x0 * x2 + x1 * x2);
        double c4 = -(a * x1 * x2 * x3
                + b * x0 * x2 * x3
                + c * x0 * x1 * x3
                + d * x0 * x1 * x2);*/
        if(c1.doubleValue() < 0){
